...
function NotFoundPage() {
  return (
    <>
      <SEOHead 
        title="404 - Страница не найдена | Explore IT"
        description="Страница не найдена. Возможно, вы ошиблись адресом или страница была удалена. Вернитесь на главную или воспользуйтесь меню."
