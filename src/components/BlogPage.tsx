...
function BlogPage() {
  ...
  const filteredPosts = selectedCategory === 'Все' 
    ? optimizedArticles 
    : optimizedArticles.filter(post => post.category === selectedCategory);
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="блог, статьи, Дубай, путешествия, экскурсии, советы путешественникам, гиды, опытные гиды, профессиональная команда, туроператор, лучшие туры, путешествия ОАЭ, туризм, отдых на море, vip туры, экскурсии с гидом, экскурсии для детей, экскурсии для взрослых, экскурсии для всей семьи, экскурсии на вертолете, экскурсии на яхте, экскурсии в пустыню, экскурсии по эмиратам, экскурсии по Персидскому заливу" />
