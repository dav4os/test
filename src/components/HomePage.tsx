...
// Используем изображения из папки public для лучшей производительности
const bgImage = '/pexels-pixabay-162031.webp';
const dubaiPremiumImg = '/pexels-apasaric-2044434.webp';
const safariImg = '/pexels-bubi-2867769.webp';
const abuDhabiImg = '/pexels-lina-12238221.webp';
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
              ...
              <div className="relative">
                <img
                  src="/pexels-apasaric-2044434.webp"
            ...
            <div className="mb-16">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className="relative order-2 lg:order-1">
                  <img
                    src="/pexels-pixabay-162031.webp"
