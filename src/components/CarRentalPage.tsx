...
function CarRentalPage() {
  ...
  const cars = [
    ...
    },
    {
      ...
      image: '/pexels-avinashpatel-544542.webp',
    ...
    },
    {
      ...
      image: '/transportnoe-sredstvo-v-dvizenii.webp',
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="аренда авто Дубай, прокат машин ОАЭ, аренда автомобиля без водителя, аренда авто с водителем, спорткары, внедорожники, кабриолеты, лимузины, премиум авто, эконом авто, бизнес авто, люкс авто, аренда на сутки, аренда на неделю, аренда на месяц, туристы, бизнес, семья, отдых, путешествия, экскурсии, трансфер, свадьба, мероприятия, фотосессия, съемки, деловые поездки, корпоративы, вечеринки, праздники" />
      ...
      <section 
        ...
        style={{
          backgroundImage: 'linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.3)), url("/photo_2025-07-12_18-52-35.webp")'
        }}
      >
