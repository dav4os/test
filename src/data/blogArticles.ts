...
**Планируете поездку в Абу-Даби?** Доверьте организацию тура профессионалам Explore IT, и мы покажем вам все грани этого удивительного города!`,
    image: "/photo_2025-07-12_19-02-57.webp",
...
**Хотите гастрономический тур по Дубаю?** Explore IT организует индивидуальные кулинарные путешествия с посещением лучших ресторанов города!`,
    image: "/photo_2025-07-12_19-16-09.webp",
...
**Планируете шоппинг-тур в ОАЭ?** Explore IT организует индивидуальные программы с посещением лучших торговых мест и получением эксклюзивных скидок!`,
    image: "/photo_2025-07-12_19-16-06.webp",
    author: "Анна Петрова",
    date: "5 декабря 2024",
    readTime: "11 мин",
    category: "Шоппинг",
...
**Хотите организовать водное приключение в ОАЭ?** Explore IT поможет выбрать лучшие активности и обеспечит безопасный и незабываемый отдых на воде!`,
    image: "/photo_2025-07-12_19-16-14.webp",
...
/**
 * Возвращает статью с оптимизированным путем к изображению
 */
export const getOptimizedBlogArticle = (article: BlogArticle): BlogArticle => {
  return {
    ...article,
    image: getOptimalImagePath(article.image)
  };
};

/**
 * Возвращает массив статей с оптимизированными путями к изображениям
 */
export const getOptimizedBlogArticles = (): BlogArticle[] => {
  return blogArticles.map(article => getOptimizedBlogArticle(article));
};